...
export default {
    ...
    watch: {
        questionIndex () {
            var vm = this
            $.get(`/api?newQuestion=true&question=${vm.questions[vm.questionIndex].text}`, function (data) {
                console.log(data)
            })
        }
    },
